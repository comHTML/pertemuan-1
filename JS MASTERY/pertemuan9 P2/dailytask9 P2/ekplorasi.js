...
// santri.nama = agus =>    // Tambah santri
// delete santri.pop() =>    // Hapus santri terakhir
// santri.push() =>    // Tambah ke awal
// santri.splice (1, 1) =>    // Hapus santri di indeks ke-2

// 🧩 Tantangan Easy
// Buat daftar 10 santri baru dalam array.
// Tambahkan 3 santri yang terlambat.
// Hapus 1 santri yang izin.
// Tampilkan total santri yang hadir.
...
let santriNama = [
  ...
  santriNama.push = ("pisang, mangga, melon")

  santriNama.splice (2, 1, "")

  console.log(santriNama);
...
let pass = "admin";
console.log(pass == "admin" || pass == "user");     // true
console.log(pass);      // admin
//====
let angka = 10;
console.log(!(angka < 5));      // true
...
let nilaiUjian = 80;
let nilaiTugas = 70;
let lulus = (nilaiUjian > 75 && nilaiTugas >= 60);
console.log("Lulus:", lulus, + nilaiUjian);
